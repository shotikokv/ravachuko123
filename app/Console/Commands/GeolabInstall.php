...
class GeolabInstall extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ravachuko:install {--force : Do not ask for user confirmation}';
     ...
     * @var string
     */
    protected $description = 'Install Ravachuko.Ge data for the Geolab Application';

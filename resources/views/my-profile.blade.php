...
@section('content')
    ...
    <div class="products-section container">
        <div class="sidebar">
            ...
            <ul>
              <li class="active"><a href="{{ route('users.edit') }}">ჩემი პროფილი</a></li>
              <li><a href="{{ route('orders.index') }}">ჩემი კალათა</a></li>
            </ul>
        </div> <!-- end sidebar -->
        <div class="my-profile">
            <div class="products-header">
                <h1 class="stylish-heading">ჩემი პროფილი</h1>
            </div>
